...
let allData = { cores: [], efeitos: [] }; // O JSON carregado vai aqui, seja PT ou EN
let currentTab = 'cores'; // No JS, usamos sempre os mesmos nomes internos (keys)
let language = 'PT'; 
let isPT = true; // Helper para facilitar os IFs no código todo
